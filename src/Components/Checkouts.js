...
<div className="container-lg">
     <div className="row my-5">
        <div className="col">
                ...
                <div className="discover mx-1 my-2">Discover more</div>
                    </div>
                    </div>
                    <div className="align-self-start">
                    <img src="https://jupiterx.com/wp-content/uploads/2022/01/Checkout-optimizer-doodle@2x.png" alt="img" className="w-75"/>
                    </div>
                    </div>
                ...
                <div className="col-md-6">
                <div className="">
                        <img src="https://jupiterx.com/wp-content/uploads/2021/12/checkout-optimizer.jpg
